<div class="page-title">
    <div>
        <h1><i class="icon-file-alt"></i>子栏目管理</h1>
    </div>
</div>
<div id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <div class="box">
            ...
            <div class="box-content">
                ...
                <form action="<?php echo $this->createUrl('form'); ?>" class="form-horizontal" method="post">
                    ...
                    <div class="control-group">
                        <label class="control-label">子栏目</label>
                        <div class="controls">
                            <label class="radio">
                                <input type="radio" name="has_sub" value="1"<?php if ($record['has_sub']) echo ' checked=""'; ?> /> Allow
                            </label>
                            <label class="radio">
                                <input type="radio" name="has_sub" value="0"<?php if (!$record['has_sub']) echo ' checked=""'; ?> /> Deny
                            </label>
                        </div>
                    </div>
